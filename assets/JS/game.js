...
function rule() {
  ...
  if (btn.value === "ON") {
    ...
    li2.innerText =
      "Click the options which is the best answer, then the background-color changes to red ";

    var li3 = document.createElement("li");
    li3.innerText =
      "The background-color of correct answer will change to white";

    var li4 = document.createElement("li");
    li4.innerText =
      "10points for each right answers will be rendered unto the score screen and zero for each wrong choices";

    var li5 = document.createElement("li");
    li5.innerText =
      "click the submit button to get total score on the score screen above";
    ul.appendChild(li1);
    ul.appendChild(li2);
    ul.appendChild(li3);
    ul.appendChild(li4);
